...
.. table:: **Table 2** Query parameters
   ...
   |                 |                 |                 |                                                                                                                                                                                                             |
   |                 |                 |                 | **cassandra**, indicating that GaussDB(for Cassandra) instances are queried.                                                                                                                                |
   |                 |                 |                 |                                                                                                                                                                                                             |
   |                 |                 |                 | If this parameter is not transferred, all types of instances are queried.                                                                                                                                   |
   +-----------------+-----------------+-----------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | mode            | No              | String          | Instance type. The value can be:                                                                                                                                                                            |
   |                 |                 |                 |                                                                                                                                                                                                             |
   |                 |                 |                 | **Cluster**, indicating GaussDB(for Cassandra) cluster instances.                                                                                                                                           |
   |                 |                 |                 |                                                                                                                                                                                                             |
   ...
   +-----------------+-----------------+-----------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | offset          | No              | Integer         | Index offset. The query starts from the next instance creation time indexed by this parameter under a specified project. If offset is set to *N*, the resource query starts from the *N*\ +1 piece of data. |
   |                 |                 |                 |                                                                                                                                                                                                             |
...
.. table:: **Table 5** ListInstancesResult
   ...
   |                       |                                                                                                             |                                                                                                                                                         |
   |                       |                                                                                                             | One GaussDB(for Cassandra) instance may use multiple subnets. For the subnet ID, see :ref:`Table 10 <nosql_05_0016__response_listinstancesnoderesult>`. |
   +-----------------------+-------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------+
...
.. table:: **Table 6** ListInstancesDatastoreResult
   ...
   +---------------+--------+-----------------------------------------------------------------------------------------------+
   | whole_version | String | Complete database version number. This parameter is available only to GaussDB(for Cassandra). |
   +---------------+--------+-----------------------------------------------------------------------------------------------+
...
.. table:: **Table 8** ListInstancesGroupResult
   ...
   |                       |                                                                                                   | The value can be:                                                                   |
   |                       |                                                                                                   |                                                                                     |
   |                       |                                                                                                   | -  **normal**, indicating that the group is running normally.                       |
   ...
   |                       |                                                                                                   | -  **expandFail**: indicating the group failed to be scaled out.                    |
   +-----------------------+---------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------+
...
.. table:: **Table 10** ListInstancesNodeResult
   ...
   |                       |                       | -  **createfail**, indicating that the node has been deleted.                                                                                                          |
