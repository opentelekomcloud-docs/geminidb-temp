...
.. table:: **Table 3** Request body parameters
   ...
   |                       |                 |                                                                      |                                                                                                                                                                                                                                                                                                                                  |
   |                       |                 |                                                                      | For details about the specifications, see parameter values under **flavor** in :ref:`Querying Instance Specifications <nosql_instance_specification>`.                                                                                                                                                                           |
   +-----------------------+-----------------+----------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
.. table:: **Table 4** Datastore
   ...
   |                 |                 |                 |                                                                                                |
   |                 |                 |                 | -  If you set this parameter to **cassandra**, GaussDB(for Cassandra) instances are supported. |
   +-----------------+-----------------+-----------------+------------------------------------------------------------------------------------------------+
...
.. table:: **Table 5** Flavor
   ...
   |                 |                 |                 |                                                                                                                                            |
   |                 |                 |                 | -  Each GaussDB(for Cassandra) instance can contain 3 to 200 nodes.                                                                        |
   +-----------------+-----------------+-----------------+--------------------------------------------------------------------------------------------------------------------------------------------+
...
-  Creating a pay-per-use 3-node GaussDB(for Cassandra) instance with 16 vCPUs and 64 GB of memory
